...
+ (NSDictionary*)defaultOptions
{
	...
	return @{
			 ...
			 AMOptionsButtonIcon : [UIImage imageNamed:@"img_topnavicon.png"],
             ...
             AMOptionsBackground : [HumanInterfaceUtility colorWithHexString:@"C0CFD6"],
			 //AMOptionsSelectionBackground : [UIColor colorWithRed:0.10 green:0.13 blue:0.20 alpha:1.0],
             AMOptionsSelectionBackground : [HumanInterfaceUtility colorWithHexString:@"#3E5561"],
			 ...
			 AMOptionsCellBackground : [HumanInterfaceUtility colorWithHexString:@"C0CFD6"],
...
+ (NSDictionary*)defaultFlatOptions
{
	...
	return @{
			 ...
			 AMOptionsCellBadgeFontColor : [UIColor whiteColor],
			 //AMOptionsCellBadgeBackColor : [UIColor blackColor],
             AMOptionsCellBadgeBackColor : [HumanInterfaceUtility colorWithHexString:@"#3E5561"],
			...
			// AMOptionsCellBackground : [UIColor colorWithRed:0.8 green:0.8 blue:0.8 alpha:1.0],
			 ...
			 AMOptionsCellSeparatorLower : [HumanInterfaceUtility colorWithHexString:@"#3E5561"],
			 AMOptionsCellShadowColor :[HumanInterfaceUtility colorWithHexString:@"#3E5561"],
			 AMOptionsImageHeight : @(44),
			 AMOptionsImageOffsetByY : @(0),
			 AMOptionsDisableMenuScroll: @NO,
			 AMOptionsAnimationShrink : @YES,
			 ...
			 AMOptionsAnimationDarkenValue : @0.7,
			// AMOptionsAnimationDarkenColor : [UIColor blackColor],
             AMOptionsAnimationDarkenColor:[HumanInterfaceUtility colorWithHexString:@"#3E5561"],
			 AMOptionsAnimationSlide : @NO,
			 AMOptionsAnimationSlidePercentage : @0.3f,
			 AMOptionsTableHeaderClass: @"AMSlideTableHeader",
			 AMOptionsTableCellClass: @"AMSlideTableCell",
			 ...
			 AMOptionsBadgeGlobalTextColor: [UIColor whiteColor],
			 AMOptionsBadgeGlobalBackColor: [UIColor redColor],
			 AMOptionsBadgeGlobalShadowColor: [HumanInterfaceUtility colorWithHexString:@"#3E5561"],
             AMOptionsShowCellSeparatorLowerBeforeHeader: @(YES),
             AMOptionsNavBarImage : [NSNull null],
			 };
}
